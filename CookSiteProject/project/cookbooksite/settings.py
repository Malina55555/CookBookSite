"""
Django settings for cookbooksite project.
...
SECRET_KEY = 'django-insecure-m@)1$*(r)a#xb$-g#19sdfoc+$rab%qaan=91-7ory-$66c%q9'
...
WSGI_APPLICATION = 'cookbooksite.wsgi.application'
